...
const char descriptor_table_protodef_order_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\022\020\n\010order_id\030\003 \001(\t2B\n\014OrderService\0222\n\tma"
  "keOrder\022\021.makeOrderRequest\032\022.makeOrderRe"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_order_2eproto = {
  false, false, 219, descriptor_table_protodef_order_2eproto, "order.proto", 
...
void OrderService::makeOrder(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void OrderService_Stub::makeOrder(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
