...
def printHelp():
    ...
    print('Usage:')
    print('Flyer_generator.py -[options][target]\n')
    print('Options:')
    print('-h, --help')
    ...
    print('')
    print('For example:')
    print('Flyer_generator.py -i order_server.proto -o ./')
...
def gen_conf_file():
    ...
    file.close()
    print('succ write to ' + out_file)
    print('End generate Flyer conf file')
    print('=' * 100)
...
def generate_framework_code(): 
    ...
    interface_test_client_file_template = Template(open(generator_path + '/template/test_Flyer_client.cc.template','r').read())
    ...
    print('End generate Flyer framework code')
    print('=' * 100)
...
def generate_project():
    ...
    try:
        ...
        print('=' * 150)
        print("Begin to generate Flyer rpc server") 
        ...
        print('Succ generate Flyer project')
        print('=' * 150)
    
    except Exception as e:
        print("Failed to generate Flyer rpc server, err: " + str(e))
        print('=' * 150)
